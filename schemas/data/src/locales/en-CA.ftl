...
qc-ResultAnalyticalMethodContext-ActivityType = The ActivityType may not be appropriate for this ResultAnalyticalMethodContext. The selected ResultAnalyticalMethodContext is typically used in the field (e.g., ActivityType 'Field Msr/Obs-Portable Data Logger')
...
qc-CharacteristicName-pH-ResultDetectionQuantitationLimitUnit-None = The unit for the CharacteristicName should be None
