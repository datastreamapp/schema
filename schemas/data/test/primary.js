...
test('MonitoringLocationVerticalAccuracyMeasure has minimum 0', () => {
  assert.equal(
    main.properties.MonitoringLocationVerticalAccuracyMeasure.minimum,
    0
  )
})
...
test('ActivityDepthAltitudeReferencePointMeasure has minimum 0', () => {
  assert.equal(
    main.properties.ActivityDepthAltitudeReferencePointMeasure.minimum,
    0
  )
})
...
test('MonitoringLocationHorizontalAccuracyMeasure has minimum 0', () => {
  assert.equal(
    main.properties.MonitoringLocationHorizontalAccuracyMeasure.minimum,
    0
  )
})
