...
test('Should accept time formats', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'pattern', 'ActivityEndTime'),
    false
  )
  assert.equal(
    checkProperty(validate.errors, 'pattern', 'AnalysisStartTime'),
    false
  )
})
...
test('Should reject BoreholeDepthMeasure > 0', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maximum', 'BoreholeDepthMeasure'),
    true
  )
})
...
test('Should reject WellDepthMeasure > 0', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maximum', 'WellDepthMeasure'),
    true
  )
})
...
test('Should reject WellOpenIntervalTopMeasure > 0', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maximum', 'WellOpenIntervalTopMeasure'),
    true
  )
})
...
test('Should reject WellOpenIntervalBottomMeasure > 0', async (t) => {
  validate({
    WellOpenIntervalBottomMeasure: 1,
    WellOpenIntervalBottomUnit: 'm',
  })
  assert.equal(
    checkProperty(validate.errors, 'maximum', 'WellOpenIntervalBottomMeasure'),
    true
  )
})
test('Should accept WellOpenIntervalBottomMeasure <= 0', async (t) => {
  validate({
    WellOpenIntervalBottomMeasure: -10,
    WellOpenIntervalBottomUnit: 'm',
  })
  assert.equal(
    checkProperty(validate.errors, 'maximum', 'WellOpenIntervalBottomMeasure'),
...
test('Should reject MonitoringLocationVerticalAccuracyMeasure < 0', async (t) => {
  validate({
    MonitoringLocationVerticalAccuracyMeasure: -1,
  ...
  assert.equal(
    checkProperty(
      validate.errors,
      'minimum',
      'MonitoringLocationVerticalAccuracyMeasure'
    ),
    true
  )
})
test('Should accept MonitoringLocationVerticalAccuracyMeasure >= 0', async (t) => {
  validate({
    MonitoringLocationVerticalAccuracyMeasure: 5,
    MonitoringLocationVerticalAccuracyUnit: 'm',
  })
  assert.equal(
    checkProperty(
...
test('Should reject ActivityDepthAltitudeReferencePointMeasure < 0', async (t) => {
  validate({
    ActivityDepthAltitudeReferencePointMeasure: -1,
  ...
  assert.equal(
    checkProperty(
      validate.errors,
      'minimum',
      'ActivityDepthAltitudeReferencePointMeasure'
    ),
    true
  )
})
test('Should accept ActivityDepthAltitudeReferencePointMeasure >= 0', async (t) => {
  validate({
    ActivityDepthAltitudeReferencePointMeasure: 5,
    ActivityDepthAltitudeReferencePointUnit: 'm',
  })
  assert.equal(
    checkProperty(
...
test('Should accept AquiferCode <= 10 chars', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maxLength', 'AquiferCode'),
    false
  )
})
...
test('Should reject SampleCollectionMethodName > 300 chars', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maxLength', 'SampleCollectionMethodName'),
    true
  )
})
...
test('Should reject SampleCollectionMethodID > 50 chars', async (t) => {
  ...
  assert.equal(
    checkProperty(validate.errors, 'maxLength', 'SampleCollectionMethodID'),
    true
  )
})
